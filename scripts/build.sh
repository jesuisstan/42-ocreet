...
for file in creatureType.eliom utils.eliom config.eliom dragging.eliom page.eliom quadtree.eliom creatureUtils.eliom creature.eliom mainUtils.eliom keepalive.eliom h42n42.eliom; do
    if [ -f "$file" ]; then
